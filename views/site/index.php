            ...
            <div class="header">
                ...
                <div class="top-nav">
                    ...
                    <ul class="nav">
                        ...
                        <a class="shop" href="cart.html"><img src="img/cart.png" alt="" /></a>
                    </ul>
                </div>
            ...
            <div class="slider">
                <div class="callbacks_container">
                    <ul class="rslides" id="slider">
                        <li>
                            <h1>WELCOME TO HANDMADE STORE</h1>
                        </li>
                        <li>
                    ...
                    <p>Menyediakan<span> Sarung Tenun</span> dan <span>Macam-Macam</span> Gerabah <span>Lainya</span></p>
                </div>
            </div>
        </div>
        <div class="dwn">
            <a class="scroll" href="#cate"><img src="img/scroll.png" alt="" /></a>
        </div>
    </div>
    <!--/banner-->
